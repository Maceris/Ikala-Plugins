...
/**
 * K.jpg's OpenSimplex 2, smooth variant ("SuperSimplex"). From
...
public class OpenSimplex2S {
    ...
    private static class LatticeVertex4D {
        ...
        public LatticeVertex4D(int xsv, int ysv, int zsv, int wsv) {
            xsvp = xsv * OpenSimplex2S.PRIME_X;
            ysvp = ysv * OpenSimplex2S.PRIME_Y;
            zsvp = zsv * OpenSimplex2S.PRIME_Z;
            wsvp = wsv * OpenSimplex2S.PRIME_W;
            float ssv = (xsv + ysv + zsv + wsv) * OpenSimplex2S.UNSKEW_4D;
            dx = -xsv - ssv;
            dy = -ysv - ssv;
            dz = -zsv - ssv;
            dw = -wsv - ssv;
    ...
    private static final double ROOT2OVER2 = 0.707_106_781_186_547_6;
    private static final double SKEW_2D = 0.366_025_403_784_439;

    private static final double UNSKEW_2D = -0.211_324_865_405_187_13;
    private static final double ROOT3OVER3 = 0.577_350_269_189_626;
    private static final double FALLBACK_ROTATE3 = 2.0 / 3.0;

    private static final double ROTATE3_ORTHOGONALIZER = OpenSimplex2S.UNSKEW_2D;
    private static final float SKEW_4D = 0.309_016_994_374_947f;

    private static final float UNSKEW_4D = -0.138_196_601_125_011f;
    ...
    private static final int N_GRADS_2D = 1 << OpenSimplex2S.N_GRADS_2D_EXPONENT;
    private static final int N_GRADS_3D = 1 << OpenSimplex2S.N_GRADS_3D_EXPONENT;

    private static final int N_GRADS_4D = 1 << OpenSimplex2S.N_GRADS_4D_EXPONENT;
    private static final double NORMALIZER_2D = 0.054_818_664_956_251_18;
    private static final double NORMALIZER_3D = 0.278_192_611_752_718_6;

    private static final double NORMALIZER_4D = 0.111_274_018_899_455_51;
    ...
    static {
        OpenSimplex2S.GRADIENTS_2D = new float[OpenSimplex2S.N_GRADS_2D * 2];
        float[] grad2 = {
            0.382_683_432_365_09f,
            0.923_879_532_511_287f,
            0.923_879_532_511_287f,
            0.382_683_432_365_09f,
            0.923_879_532_511_287f,
            -0.382_683_432_365_09f,
            ...
            0.923_879_532_511_287f,
            // -------------------------------------//
            0.130_526_192_220_052f,
            0.991_444_861_373_81f,
            0.608_761_429_008_721f,
            0.793_353_340_291_235f,
            0.793_353_340_291_235f,
            0.608_761_429_008_721f,
            0.991_444_861_373_81f,
            0.130_526_192_220_051f,
            0.991_444_861_373_81f,
            -0.130_526_192_220_051f,
            0.793_353_340_291_235f,
            -0.608_761_429_008_72f,
            0.608_761_429_008_721f,
            -0.793_353_340_291_235f,
            0.130_526_192_220_052f,
            -0.991_444_861_373_81f,
        ...
        for (int i = 0; i < grad2.length; i++) {
            grad2[i] = (float) (grad2[i] / OpenSimplex2S.NORMALIZER_2D);
        }
        for (int i = 0, j = 0; i < OpenSimplex2S.GRADIENTS_2D.length; i++, j++) {
            if (j == grad2.length) {
                j = 0;
            }
            OpenSimplex2S.GRADIENTS_2D[i] = grad2[j];
        }

        OpenSimplex2S.GRADIENTS_3D = new float[OpenSimplex2S.N_GRADS_3D * 4];
        float[] grad3 = {
            2.224_744_871_39f,
            2.224_744_871_39f,
            -1.0f,
            ...
            1.0f,
            0.0f,
            3.086_266_468_797_201_7f,
            1.172_151_342_246_497_8f,
            0.0f,
            0.0f,
            1.172_151_342_246_497_8f,
            3.086_266_468_797_201_7f,
        ...
        for (int i = 0; i < grad3.length; i++) {
            grad3[i] = (float) (grad3[i] / OpenSimplex2S.NORMALIZER_3D);
        }
        for (int i = 0, j = 0; i < OpenSimplex2S.GRADIENTS_3D.length; i++, j++) {
            if (j == grad3.length) {
                j = 0;
            }
            OpenSimplex2S.GRADIENTS_3D[i] = grad3[j];
        }

        OpenSimplex2S.GRADIENTS_4D = new float[OpenSimplex2S.N_GRADS_4D * 4];
        float[] grad4 = {
            -0.674_005_951_781_294_4f,
            -0.323_984_777_199_753_7f,
            -0.323_984_777_199_753_7f,
            0.579_468_467_864_338_1f,
            -0.750_488_382_875_560_2f,
            -0.400_467_208_294_019_5f,
            0.152_964_862_188_531_64f,
            0.502_986_036_770_072_4f,
            -0.750_488_382_875_560_2f,
            0.152_964_862_188_531_64f,
            -0.400_467_208_294_019_5f,
            0.502_986_036_770_072_4f,
            -0.882_816_187_537_358_5f,
            0.081_647_292_856_809_45f,
            0.081_647_292_856_809_45f,
            0.455_305_411_960_271_2f,
            -0.455_305_411_960_271_2f,
            -0.081_647_292_856_809_45f,
            -0.081_647_292_856_809_45f,
            0.882_816_187_537_358_5f,
            ...
            0.323_984_777_199_753_7f,
            // ------------------------------------------------------------------------------------------//
            -0.753_341_017_856_078f,
            -0.379_682_898_752_616_24f,
            -0.379_682_898_752_616_24f,
            -0.379_682_898_752_616_24f,
            -0.782_168_443_118_070_8f,
            -0.432_147_268_536_530_1f,
            -0.432_147_268_536_530_1f,
            0.121_284_801_946_020_98f,
            -0.782_168_443_118_070_8f,
            -0.432_147_268_536_530_1f,
            0.121_284_801_946_020_98f,
            -0.432_147_268_536_530_1f,
            ...
            -0.432_147_268_536_530_1f,
            -0.432_147_268_536_530_1f,
            -0.858_650_874_212_336_5f,
            -0.508_629_699_630_796f,
            0.044_802_370_851_755_174f,
            0.044_802_370_851_755_174f,
            -0.858_650_874_212_336_5f,
            0.044_802_370_851_755_174f,
            -0.508_629_699_630_796f,
            ...
            0.044_802_370_851_755_174f,
            -0.508_629_699_630_796f,
            -0.998_282_896_426_506_2f,
            -0.033_819_416_032_338_42f,
            -0.033_819_416_032_338_42f,
            -0.033_819_416_032_338_42f,
            -0.379_682_898_752_616_24f,
            -0.753_341_017_856_078f,
        ...
        for (int i = 0; i < grad4.length; i++) {
            grad4[i] = (float) (grad4[i] / OpenSimplex2S.NORMALIZER_4D);
        }
        for (int i = 0, j = 0; i < OpenSimplex2S.GRADIENTS_4D.length; i++, j++) {
            if (j == grad4.length) {
                j = 0;
            }
            OpenSimplex2S.GRADIENTS_4D[i] = grad4[j];
        }
        ...
        int[][] lookup4DVertexCodes = {
            ...
            new int[] {
                0x01, 0x15, 0x16, 0x45, 0x46, 0x51, 0x52, 0x55, 0x56, 0x5A, 0x66, 0x6A, 0x96, 0x9A,
                0xA6, 0xAA, 0xAB
            },
            new int[] {
                0x15, 0x45, 0x54, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x69, 0x6A, 0x95, 0x99, 0x9A, 0xA9,
                0xAA
            },
            new int[] {
                0x05, 0x15, 0x45, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x99,
                0x9A, 0xAA
            },
            new int[] {0x05, 0x15, 0x45, 0x55, 0x56, 0x59, 0x5A, 0x66, 0x6A, 0x96, 0x9A, 0xAA},
            new int[] {
                0x05, 0x15, 0x16, 0x45, 0x46, 0x55, 0x56, 0x59, 0x5A, 0x66, 0x6A, 0x96, 0x9A, 0xAA,
                0xAB
            },
            new int[] {
            ...
            new int[] {
                0x11, 0x15, 0x16, 0x51, 0x52, 0x55, 0x56, 0x5A, 0x65, 0x66, 0x6A, 0x96, 0xA6, 0xAA,
                0xAB
            },
            new int[] {
                0x14, 0x15, 0x54, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x99, 0xA5,
                0xA9, 0xAA
            },
            new int[] {
            ...
            new int[] {
                0x14, 0x15, 0x19, 0x54, 0x55, 0x58, 0x59, 0x5A, 0x65, 0x69, 0x6A, 0x99, 0xA9, 0xAA,
                0xAE
            },
            new int[] {
            ...
            new int[] {
                0x10, 0x11, 0x14, 0x15, 0x50, 0x51, 0x54, 0x55, 0x65, 0x66, 0x69, 0x6A, 0xA5, 0xA6,
                0xA9, 0xAA
            },
            ...
            new int[] {
                0x15, 0x55, 0x56, 0x59, 0x5A, 0x66, 0x69, 0x6A, 0x6B, 0x6E, 0x9A, 0xAA, 0xAB, 0xAE,
                0xAF
            },
            new int[] {
                0x10, 0x15, 0x25, 0x51, 0x54, 0x55, 0x61, 0x64, 0x65, 0x66, 0x69, 0x6A, 0xA5, 0xA6,
                0xA9, 0xAA, 0xBA
            },
            new int[] {
                0x11, 0x15, 0x25, 0x51, 0x55, 0x56, 0x61, 0x65, 0x66, 0x69, 0x6A, 0xA5, 0xA6, 0xAA,
                0xBA
            },
            new int[] {
            ...
            new int[] {
                0x11, 0x15, 0x26, 0x51, 0x55, 0x56, 0x62, 0x65, 0x66, 0x67, 0x6A, 0x76, 0xA6, 0xAA,
                0xAB, 0xBA, 0xBB
            },
            new int[] {
                0x14, 0x15, 0x25, 0x54, 0x55, 0x59, 0x64, 0x65, 0x66, 0x69, 0x6A, 0xA5, 0xA9, 0xAA,
                0xBA
            },
            new int[] {
            ...
            new int[] {
                0x15, 0x55, 0x56, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x6B, 0x7A, 0xA6, 0xAA, 0xAB, 0xBA,
                0xBB
            },
            new int[] {
                0x14, 0x15, 0x29, 0x54, 0x55, 0x59, 0x65, 0x68, 0x69, 0x6A, 0x6D, 0x79, 0xA9, 0xAA,
                0xAE, 0xBA, 0xBE
            },
            new int[] {
            ...
            new int[] {
                0x15, 0x55, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x6E, 0x7A, 0xA9, 0xAA, 0xAE, 0xBA,
                0xBE
            },
            new int[] {
                0x15, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x6B, 0x6E, 0x7A, 0xAA, 0xAB,
                0xAE, 0xBA, 0xBF
            },
            new int[] {
            ...
            new int[] {
                0x41, 0x45, 0x51, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x95, 0x96, 0x99, 0x9A, 0xA5,
                0xA6, 0xAA
            },
            new int[] {0x41, 0x45, 0x51, 0x55, 0x56, 0x5A, 0x66, 0x95, 0x96, 0x9A, 0xA6, 0xAA},
            new int[] {
                0x41, 0x45, 0x46, 0x51, 0x52, 0x55, 0x56, 0x5A, 0x66, 0x95, 0x96, 0x9A, 0xA6, 0xAA,
                0xAB
            },
            new int[] {
                0x44, 0x45, 0x54, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x69, 0x95, 0x96, 0x99, 0x9A, 0xA5,
                0xA9, 0xAA
            },
            new int[] {
            ...
            new int[] {
                0x44, 0x45, 0x49, 0x54, 0x55, 0x58, 0x59, 0x5A, 0x69, 0x95, 0x99, 0x9A, 0xA9, 0xAA,
                0xAE
            },
            new int[] {
            ...
            new int[] {
                0x50, 0x51, 0x54, 0x55, 0x56, 0x59, 0x65, 0x66, 0x69, 0x95, 0x96, 0x99, 0xA5, 0xA6,
                0xA9, 0xAA
            },
            new int[] {
            ...
            new int[] {
                0x15, 0x45, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x99, 0x9A,
            ...
            new int[] {
                0x15, 0x51, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x96, 0x9A, 0xA5,
            ...
            new int[] {
                0x15, 0x54, 0x55, 0x56, 0x59, 0x5A, 0x65, 0x66, 0x69, 0x6A, 0x95, 0x99, 0x9A, 0xA5,
            ...
            new int[] {
                0x50, 0x51, 0x54, 0x55, 0x61, 0x64, 0x65, 0x66, 0x69, 0x95, 0xA5, 0xA6, 0xA9, 0xAA,
                0xBA
            },
            new int[] {
            ...
            new int[] {
                0x40, 0x41, 0x44, 0x45, 0x50, 0x51, 0x54, 0x55, 0x95, 0x96, 0x99, 0x9A, 0xA5, 0xA6,
                0xA9, 0xAA
            },
            ...
            new int[] {
                0x45, 0x55, 0x56, 0x59, 0x5A, 0x6A, 0x96, 0x99, 0x9A, 0x9B, 0x9E, 0xAA, 0xAB, 0xAE,
                0xAF
            },
        ...
        OpenSimplex2S.LOOKUP_4D_A = new int[256];
        OpenSimplex2S.LOOKUP_4D_B = new LatticeVertex4D[nLatticeVerticesTotal];
        for (int i = 0, j = 0; i < 256; i++) {
            OpenSimplex2S.LOOKUP_4D_A[i] = j | ((j + lookup4DVertexCodes[i].length) << 16);
            for (int k = 0; k < lookup4DVertexCodes[i].length; k++) {
                OpenSimplex2S.LOOKUP_4D_B[j++] = latticeVerticesByCode[lookup4DVertexCodes[i][k]];
            }
        }
    }
    ...
    private static float grad(long seed, long xsvp, long ysvp, float dx, float dy) {
        ...
        hash ^= hash >> (64 - OpenSimplex2S.N_GRADS_2D_EXPONENT + 1);
        int gi = (int) hash & ((OpenSimplex2S.N_GRADS_2D - 1) << 1);
        return OpenSimplex2S.GRADIENTS_2D[gi | 0] * dx + OpenSimplex2S.GRADIENTS_2D[gi | 1] * dy;
    }
    ...
    private static float grad(
        ...
        hash *= OpenSimplex2S.HASH_MULTIPLIER;
        hash ^= hash >> (64 - OpenSimplex2S.N_GRADS_3D_EXPONENT + 2);
        int gi = (int) hash & ((OpenSimplex2S.N_GRADS_3D - 1) << 2);
        return OpenSimplex2S.GRADIENTS_3D[gi | 0] * dx
                + OpenSimplex2S.GRADIENTS_3D[gi | 1] * dy
                + OpenSimplex2S.GRADIENTS_3D[gi | 2] * dz;
    }
    ...
    private static float grad(
        ...
        hash *= OpenSimplex2S.HASH_MULTIPLIER;
        hash ^= hash >> (64 - OpenSimplex2S.N_GRADS_4D_EXPONENT + 2);
        int gi = (int) hash & ((OpenSimplex2S.N_GRADS_4D - 1) << 2);
        return (OpenSimplex2S.GRADIENTS_4D[gi | 0] * dx + OpenSimplex2S.GRADIENTS_4D[gi | 1] * dy)
                + (OpenSimplex2S.GRADIENTS_4D[gi | 2] * dz
                        + OpenSimplex2S.GRADIENTS_4D[gi | 3] * dw);
    }
    ...
    public static float noise2(long seed, double x, double y) {
        ...
        double s = OpenSimplex2S.SKEW_2D * (x + y);
    ...
    public static float noise2_ImproveX(long seed, double x, double y) {
        ...
        double xx = x * OpenSimplex2S.ROOT2OVER2;
        double yy = y * (OpenSimplex2S.ROOT2OVER2 * (1 + 2 * OpenSimplex2S.SKEW_2D));
    ...
    private static float noise2_UnskewedBase(long seed, double xs, double ys) {
        ...
        long xsbp = xsb * OpenSimplex2S.PRIME_X, ysbp = ysb * OpenSimplex2S.PRIME_Y;

        // Unskew.
        float t = (xi + yi) * (float) OpenSimplex2S.UNSKEW_2D;
        float dx0 = xi + t, dy0 = yi + t;

        // First vertex.
        float a0 = OpenSimplex2S.RSQUARED_2D - dx0 * dx0 - dy0 * dy0;
        float value = (a0 * a0) * (a0 * a0) * OpenSimplex2S.grad(seed, xsbp, ysbp, dx0, dy0);

        // Second vertex.
        float a1 =
                (float) (2 * (1 + 2 * OpenSimplex2S.UNSKEW_2D) * (1 / OpenSimplex2S.UNSKEW_2D + 2))
                                * t
                        + ((float)
                                        (-2
                                                ...
                                                * (1 + 2 * OpenSimplex2S.UNSKEW_2D))
                                + a0);
        float dx1 = dx0 - (float) (1 + 2 * OpenSimplex2S.UNSKEW_2D);
        float dy1 = dy0 - (float) (1 + 2 * OpenSimplex2S.UNSKEW_2D);
        value +=
                (a1 * a1)
                        * (a1 * a1)
                        * OpenSimplex2S.grad(
        ...
        if (t < OpenSimplex2S.UNSKEW_2D) {
            if (xi + xmyi > 1) {
                float dx2 = dx0 - (float) (3 * OpenSimplex2S.UNSKEW_2D + 2);
                float dy2 = dy0 - (float) (3 * OpenSimplex2S.UNSKEW_2D + 1);
                float a2 = OpenSimplex2S.RSQUARED_2D - dx2 * dx2 - dy2 * dy2;
                if (a2 > 0) {
                    value +=
                            (a2 * a2)
                                    * (a2 * a2)
                ...
                float dx2 = dx0 - (float) OpenSimplex2S.UNSKEW_2D;
                float dy2 = dy0 - (float) (OpenSimplex2S.UNSKEW_2D + 1);
                float a2 = OpenSimplex2S.RSQUARED_2D - dx2 * dx2 - dy2 * dy2;
                if (a2 > 0) {
                    value +=
                            (a2 * a2)
                                    * (a2 * a2)
                                    * OpenSimplex2S.grad(
                                            seed, xsbp, ysbp + OpenSimplex2S.PRIME_Y, dx2, dy2);
                }
            }

            if (yi - xmyi > 1) {
                float dx3 = dx0 - (float) (3 * OpenSimplex2S.UNSKEW_2D + 1);
                float dy3 = dy0 - (float) (3 * OpenSimplex2S.UNSKEW_2D + 2);
                float a3 = OpenSimplex2S.RSQUARED_2D - dx3 * dx3 - dy3 * dy3;
                if (a3 > 0) {
                    value +=
                            (a3 * a3)
                                    * (a3 * a3)
                ...
                float dx3 = dx0 - (float) (OpenSimplex2S.UNSKEW_2D + 1);
                float dy3 = dy0 - (float) OpenSimplex2S.UNSKEW_2D;
                float a3 = OpenSimplex2S.RSQUARED_2D - dx3 * dx3 - dy3 * dy3;
                if (a3 > 0) {
                    value +=
                            (a3 * a3)
                                    * (a3 * a3)
                                    * OpenSimplex2S.grad(
                                            seed, xsbp + OpenSimplex2S.PRIME_X, ysbp, dx3, dy3);
                }
            }
        } else {
            if (xi + xmyi < 0) {
                float dx2 = dx0 + (float) (1 + OpenSimplex2S.UNSKEW_2D);
                float dy2 = dy0 + (float) OpenSimplex2S.UNSKEW_2D;
                float a2 = OpenSimplex2S.RSQUARED_2D - dx2 * dx2 - dy2 * dy2;
                if (a2 > 0) {
                    value +=
                            (a2 * a2)
                                    * (a2 * a2)
                                    * OpenSimplex2S.grad(
                                            seed, xsbp - OpenSimplex2S.PRIME_X, ysbp, dx2, dy2);
                }
            } else {
                float dx2 = dx0 - (float) (OpenSimplex2S.UNSKEW_2D + 1);
                float dy2 = dy0 - (float) OpenSimplex2S.UNSKEW_2D;
                float a2 = OpenSimplex2S.RSQUARED_2D - dx2 * dx2 - dy2 * dy2;
                if (a2 > 0) {
                    value +=
    ...
    public static float noise3_Fallback(long seed, double x, double y, double z) {
        ...
        // Re-orient the cubic lattices via rotation, to produce a familiar
        // look.
        // Orthonormal rotation. Not a skew transform.
        double r = OpenSimplex2S.FALLBACK_ROTATE3 * (x + y + z);
    ...
    public static float noise3_ImproveXY(long seed, double x, double y, double z) {
        ...
        // lattice diagonal,
        // and the planes formed by XY are moved far out of alignment with the
        // cube faces.
        // Orthonormal rotation. Not a skew transform.
        double xy = x + y;
        double s2 = xy * OpenSimplex2S.ROTATE3_ORTHOGONALIZER;
        double zz = z * OpenSimplex2S.ROOT3OVER3;
        double xr = x + s2 + zz;
        double yr = y + s2 + zz;
        double zr = xy * -OpenSimplex2S.ROOT3OVER3 + zz;
    ...
    public static float noise3_ImproveXZ(long seed, double x, double y, double z) {
        ...
        // Re-orient the cubic lattices without skewing, so Y points up the main
        // lattice diagonal,
        // and the planes formed by XZ are moved far out of alignment with the
        // cube faces.
        // Orthonormal rotation. Not a skew transform.
        double xz = x + z;
        double s2 = xz * -0.211_324_865_405_187;
        double yy = y * OpenSimplex2S.ROOT3OVER3;
        double xr = x + s2 + yy;
        double zr = z + s2 + yy;
        double yr = xz * -OpenSimplex2S.ROOT3OVER3 + yy;
    ...
    private static float noise3_UnrotatedBase(long seed, double xr, double yr, double zr) {
        ...
        // copy.
        long xrbp = xrb * OpenSimplex2S.PRIME_X,
                yrbp = yrb * OpenSimplex2S.PRIME_Y,
                zrbp = zrb * OpenSimplex2S.PRIME_Z;
        ...
        float y0 = yi + yNMask;
        float z0 = zi + zNMask;
        float a0 = OpenSimplex2S.RSQUARED_3D - x0 * x0 - y0 * y0 - z0 * z0;
        float value =
                (a0 * a0)
                        * (a0 * a0)
                        * OpenSimplex2S.grad(
                                seed,
                                xrbp + (xNMask & OpenSimplex2S.PRIME_X),
                                yrbp + (yNMask & OpenSimplex2S.PRIME_Y),
                                zrbp + (zNMask & OpenSimplex2S.PRIME_Z),
                                x0,
                                y0,
                                z0);
        ...
        float y1 = yi - 0.5f;
        float z1 = zi - 0.5f;
        float a1 = OpenSimplex2S.RSQUARED_3D - x1 * x1 - y1 * y1 - z1 * z1;
        value +=
                (a1 * a1)
                        * (a1 * a1)
                        * OpenSimplex2S.grad(
                                seed2,
                                xrbp + OpenSimplex2S.PRIME_X,
                                yrbp + OpenSimplex2S.PRIME_Y,
                                zrbp + OpenSimplex2S.PRIME_Z,
                                x1,
                                y1,
                                z1);
            ...
            if (a4 > 0) {
                ...
                value +=
                        (a4 * a4)
                                ...
                                * OpenSimplex2S.grad(
                                        seed2,
                                        xrbp + (xNMask & (OpenSimplex2S.PRIME_X * 2)),
                                        yrbp + OpenSimplex2S.PRIME_Y,
                                        zrbp + OpenSimplex2S.PRIME_Z,
                                        x4,
                                        y4,
                ...
                value +=
                        (a8 * a8)
                                ...
                                * OpenSimplex2S.grad(
                                        seed2,
                                        xrbp + OpenSimplex2S.PRIME_X,
                                        yrbp + (yNMask & (OpenSimplex2S.PRIME_Y << 1)),
                                        zrbp + OpenSimplex2S.PRIME_Z,
                                        x8,
                                        y8,
                                        z8);
                ...
                value +=
                        (aC * aC)
                                ...
                                * OpenSimplex2S.grad(
                                        ...
                                        xrbp + OpenSimplex2S.PRIME_X,
                                        yrbp + OpenSimplex2S.PRIME_Y,
                                        zrbp + (zNMask & (OpenSimplex2S.PRIME_Z << 1)),
                                        xC,
                                        yC,
                                        zC);
                skipD = true;
            ...
            if (aD > 0) {
                ...
                value +=
                        (aD * aD)
                                ...
                                * OpenSimplex2S.grad(
                                        seed2,
                                        xrbp + (xNMask & (OpenSimplex2S.PRIME_X << 1)),
                                        yrbp + (yNMask & (OpenSimplex2S.PRIME_Y << 1)),
                                        zrbp + OpenSimplex2S.PRIME_Z,
                                        xD,
                                        yD,
    ...
    public static float noise4_Fallback(long seed, double x, double y, double z, double w) {
        ...
        double s = OpenSimplex2S.SKEW_4D * (x + y + z + w);
    ...
    public static float noise4_ImproveXY_ImproveZW(
        ...
        double s2 =
                (x + y) * -0.285_225_139_874_348_769_41 + (z + w) * 0.838_970_654_706_114_357_18;
        double t2 =
                (z + w) * 0.219_397_498_837_064_357_19 + (x + y) * -0.482_148_564_933_024_769_42;
    ...
    public static float noise4_ImproveXYZ(long seed, double x, double y, double z, double w) {
        double xyz = x + y + z;
        double ww = w * 1.118_033_988_749_894;
    ...
    public static float noise4_ImproveXYZ_ImproveXY(
            long seed, double x, double y, double z, double w) {
        double xy = x + y;
        double s2 = xy * -0.211_324_865_405_186_999_98;
        double zz = z * 0.288_675_134_594_812_942_26;
        double ww = w * 1.118_033_988_749_894;
        double xr = x + (zz + ww + s2), yr = y + (zz + ww + s2);
        double zr = xy * -0.577_350_269_189_625_999_98 + (zz + ww);
        double wr = z * -0.866_025_403_784_439 + ww;
    ...
    public static float noise4_ImproveXYZ_ImproveXZ(
            long seed, double x, double y, double z, double w) {
        double xz = x + z;
        double s2 = xz * -0.211_324_865_405_186_999_98;
        double yy = y * 0.288_675_134_594_812_942_26;
        double ww = w * 1.118_033_988_749_894;
        double xr = x + (yy + ww + s2), zr = z + (yy + ww + s2);
        double yr = xz * -0.577_350_269_189_625_999_98 + (yy + ww);
        double wr = y * -0.866_025_403_784_439 + ww;
     ...
     */
    private static float noise4_UnskewedBase(
            long seed, double xs, double ys, double zs, double ws) {

        // Get base points and offsets
        int xsb = OpenSimplex2S.fastFloor(xs),
                ysb = OpenSimplex2S.fastFloor(ys),
                zsb = OpenSimplex2S.fastFloor(zs),
                wsb = OpenSimplex2S.fastFloor(ws);
        ...
        // Unskewed offsets
        float ssi = (xsi + ysi + zsi + wsi) * OpenSimplex2S.UNSKEW_4D;
        float xi = xsi + ssi, yi = ysi + ssi, zi = zsi + ssi, wi = wsi + ssi;

        // Prime pre-multiplication for hash.
        long xsvp = xsb * OpenSimplex2S.PRIME_X,
                ysvp = ysb * OpenSimplex2S.PRIME_Y,
                zsvp = zsb * OpenSimplex2S.PRIME_Z,
                wsvp = wsb * OpenSimplex2S.PRIME_W;

        // Index into initial table.
        int index =
                ((OpenSimplex2S.fastFloor(xs * 4) & 3) << 0)
                        | ((OpenSimplex2S.fastFloor(ys * 4) & 3) << 2)
                        | ((OpenSimplex2S.fastFloor(zs * 4) & 3) << 4)
                        | ((OpenSimplex2S.fastFloor(ws * 4) & 3) << 6);

        // Point contributions
        float value = 0;
        int secondaryIndexStartAndStop = OpenSimplex2S.LOOKUP_4D_A[index];
        ...
        for (int i = secondaryIndexStart; i < secondaryIndexStop; i++) {
            LatticeVertex4D c = OpenSimplex2S.LOOKUP_4D_B[i];
            float dx = xi + c.dx, dy = yi + c.dy, dz = zi + c.dz, dw = wi + c.dw;
            float a = (dx * dx + dy * dy) + (dz * dz + dw * dw);
            if (a < OpenSimplex2S.RSQUARED_4D) {
                a -= OpenSimplex2S.RSQUARED_4D;
                a *= a;
                value +=
                        a
                                * a
