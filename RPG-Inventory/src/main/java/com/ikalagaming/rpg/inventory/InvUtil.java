...
public class InvUtil {
    /**
     * Checks if an item can stack based on what kind of item it is. Equipment (weapons, armor,
     * etc.) are always unique and so can't stack, but pretty much everything else can.
     *
    ...
    /**
     * Return the maximum stack size for an item, based on what kind of item it is.
     *
