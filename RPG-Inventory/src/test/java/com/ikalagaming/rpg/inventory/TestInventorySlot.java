...
class TestInventorySlot {
    ...
    void testCombineCompleteTransfer() {
        ...
        ItemStack secondStack = new ItemStack(secondItem, InvUtil.maxStackSize(secondItem));
        ...
        Assertions.assertEquals(secondSlot.getItemStack().getItem().getID(), secondItem.getID());
    }
    ...
    void testCombineDifferentTypes() {
        ...
        Assertions.assertEquals(firstSlot.getItemStack().getItem().getID(), firstItem.getID());
    ...
    void testCombineEmptyDestination() {
        ...
        Assertions.assertFalse(secondSlot.isEmpty());
        Assertions.assertNotNull(secondSlot.getItemStack());
        Assertions.assertEquals(secondSlot.getItemStack().getItem().getID(), firstItem.getID());
        Assertions.assertTrue(firstSlot.isEmpty());
        Assertions.assertEquals(0, firstSlot.getCount());
    }
    ...
    void testCombineFullDestination() {
        ...
        Assertions.assertNotNull(firstSlot.getItemStack());
        Assertions.assertEquals(firstSlot.getItemStack().getItem().getID(), firstItem.getID());
        Assertions.assertEquals(InvUtil.maxStackSize(secondItem), secondSlot.getCount());
        Assertions.assertFalse(secondSlot.isEmpty());
        Assertions.assertNotNull(secondSlot.getItemStack());
        Assertions.assertEquals(secondSlot.getItemStack().getItem().getID(), secondItem.getID());
    }
    ...
    /**
     * Test the {@link InventorySlot#combine(InventorySlot, InventorySlot)} method for non-stackable
     * items.
     */
    @Test
    void testCombineNonStackables() {
        ...
        Assertions.assertEquals(secondItem.getID(), secondSlot.getItem().getID());
    }
    ...
    void testIsStackable() {
        ...
        Assertions.assertTrue(slot.setItemStack(new ItemStack(new Consumable(), 4)));
    ...
    void testSwapContents() {
        ...
        Assertions.assertEquals(firstSlot.getItem().getID(), secondItem.getID());
        Assertions.assertEquals(secondSlot.getItem().getID(), firstItem.getID());
        Assertions.assertNull(firstSlot.getItemStack());
        Assertions.assertNotNull(secondSlot.getItemStack());
        Assertions.assertEquals(secondSlot.getItemStack().getItem().getID(), firstItem.getID());
        ...
        Assertions.assertEquals(emptySlot.getItemStack().getItem().getID(), firstItem.getID());
    }
}
