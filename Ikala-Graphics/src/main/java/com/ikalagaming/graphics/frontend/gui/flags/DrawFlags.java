...
public class DrawFlags {
    ...
    public static final int ROUND_CORNERS_BOTTOM =
            ROUND_CORNERS_BOTTOM_LEFT | ROUND_CORNERS_BOTTOM_RIGHT;
    public static final int ROUND_CORNERS_LEFT = ROUND_CORNERS_TOP_LEFT | ROUND_CORNERS_BOTTOM_LEFT;
    public static final int ROUND_CORNERS_RIGHT =
            ROUND_CORNERS_TOP_RIGHT | ROUND_CORNERS_BOTTOM_RIGHT;
    public static final int ROUND_CORNERS_ALL =
