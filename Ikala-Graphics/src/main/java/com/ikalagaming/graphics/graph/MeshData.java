...
public class MeshData {
    ...
    /**
     * A list of bitangent values, in x, y, z order. Bitangents point in the direction of the
     * positive Y texture axis.
     *
    ...
    /**
     * Lists of bone IDs that affect the vertices, ordered by vertex ID. Each vertex has {@link
     * ModelLoader#MAX_WEIGHTS} entries in the list, and if there are less than that number of bones
     * affecting the vertex, the remaining positions are filled with zeroes. Each index in this list
     * is the bone ID corresponding to the weight in the weight list at the same position.
     *
    ...
    /**
     * A list of tangent values, in x, y, z order. Tangents point in the direction of the positive X
     * texture axis.
     *
     * @return The values of tangents.
     */
    ...
    /**
     * Lists of weights that affect the vertices, ordered by vertex ID. Each vertex has {@link
     * ModelLoader#MAX_WEIGHTS} entries in the list, and if there are less than that number of bones
     * affecting the vertex, the remaining positions are filled with zeroes. Each index in this list
     * is the weight corresponding to the bone ID in the bone ID list at the same position.
     *
     ...
     * @param tangents A list of tangent values, in x, y, z order. Tangents point in the direction
     ...
     * @param weights Lists of weights that affect the vertices, ordered by vertex ID. Each vertex
     *     has {@link ModelLoader#MAX_WEIGHTS} entries in the list.
     * @param aabbMin The minimum value (corner) of the axis-aligned bounding box that is generated
     *     by Assimp.
     * @param aabbMax The maximum value (corner) of the axis-aligned bounding box that is generated
     *     by Assimp.
     */
    public MeshData(
            float[] positions,
