...
public class MeshData {
	 ...
	 * vertex has {@link ModelLoader#MAX_WEIGHTS} entries in the list, and if
	 * there are less than that number of bones affecting the vertex, the
	 * remaining positions are filled with zeroes. Each index in this list is
	 * the bone ID corresponding to the weight in the weight list at the same
	 * position.
	 *
	 ...
	 * there are less than that number of bones affecting the vertex, the
	 * remaining positions are filled with zeroes. Each index in this list is
	 * the weight corresponding to the bone ID in the bone ID list at the same
	 * position.
	 *
	 ...
	 *            vertex ID. Each vertex has {@link ModelLoader#MAX_WEIGHTS}
	 *            entries in the list.
	...
	public MeshData(float[] positions, float[] normals, float[] tangents,
		float[] bitangents, float[] textCoords, int[] indices,
