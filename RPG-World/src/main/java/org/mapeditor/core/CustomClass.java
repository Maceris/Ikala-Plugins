...
public class CustomClass {
    ...
    public static class Member {
        ...
        /**
         * The value of the entry. This will be a string form for most entries, however it will the
         * propertytype for classes, so that we know what kind of class is stored.
         */
         ...
         * @param value The value of the element. Should be set to the propretyType if an
         *     enum/class, as we will use more concrete values in that case.
         */
        public Member(@NonNull String name, @NonNull String type, @NonNull String value) {
            this.name = name;
            this.type = type;
            this.value = value;
            enumType = null;
        ...
        public Color toColor() {
            return Member.stringToColor(value);
        }
    ...
    public boolean getBoolean(@NonNull String memberName) {
        Optional<Member> member = getMember(memberName);
        if (member.isEmpty()) {
            return false;
        }
     ...
     *
     * @param memberName The name of the member.
     * @return An optional that is either empty or contains the first child we could find with that
     *     name.
     */
    public Optional<Member> getMember(@NonNull String memberName) {
        return members.stream().filter(member -> memberName.equals(member.getName())).findFirst();
    }
