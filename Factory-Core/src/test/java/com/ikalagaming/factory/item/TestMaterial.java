...
class TestMaterial {
	...
	void testComparison() {
		...
		Assertions.assertAll(() -> Assertions.assertNotEquals(parent1, parent2),
	...
	void testMaterialConstructorExceptions() {
		...
		Assertions.assertThrows(NullPointerException.class,
			() -> new Material(nullName, normalList, parent));
		Assertions.assertThrows(NullPointerException.class,
	...
	void testMaterialCreation() {
		...
		Material parent = new Material("parent");
		Assertions.assertAll(() -> new Material("Sample1"),
