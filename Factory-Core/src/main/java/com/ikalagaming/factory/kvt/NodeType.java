...
public enum NodeType {
    ...
    BYTE_ARRAY('B', (byte) 3),
    /** A 64-bit, double-precision floating-point, ranging between -1.7E+308 to +1.7E+308. */
    DOUBLE('\0', (byte) 4),
    /** Ordered list of doubles. */
    DOUBLE_ARRAY('D', (byte) 5),
    /** A 32-bit, single-precision floating-point number, ranging between -3.4E+38 to +3.4E+38. */
    FLOAT('\0', (byte) 6),
    ...
    /**
     * A signed 64-bit integer, ranging from -9,223,372,036,854,775,808 to 9,223,372,036,854,775,807
     * (inclusive).
     */
    LONG('\0', (byte) 10),
    ...
    /**
     * Convert the the letter prefix used in the string form of the arrays to type of node.
     *
    ...
    /**
     * The letter used to indicate the type of an array in text format. Not applicable for non-array
     * node types.
     */
