...
public class Item {
    ...
    public static final String MOD_NAME_FORMAT = "^[a-zA-Z][a-zA-Z0-9_-]{0,31}$";

    /** The regex pattern that matches valid item names. */
    public static final String ITEM_NAME_FORMAT = "^[a-zA-Z][a-zA-Z0-9_-]{0,63}$";

    /** Used to separate the mod name and item name in the fully qualified format. */
    public static final String COMBINED_NAME_SEPARATOR = ":";

    /**
     * The regex pattern that matches the fully qualified item name format, which combines mod and
     * item name.
     */
    public static final String COMBINED_NAME_FORMAT =
            MOD_NAME_FORMAT + COMBINED_NAME_SEPARATOR + ITEM_NAME_FORMAT;
    ...
    public static String combineName(@NonNull String modName, @NonNull String itemName) {
        return String.format("%s%s%s", modName, COMBINED_NAME_SEPARATOR, itemName);
    }
}
