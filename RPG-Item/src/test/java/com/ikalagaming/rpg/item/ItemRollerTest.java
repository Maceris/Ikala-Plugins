				...
				.allMatch(expectedAttribute -> actual.stream()
					.anyMatch(actualAttribute -> ItemRollerTest
						.attributeModifierValid(expectedAttribute,
							actualAttribute))),
			"Expected everything in " + ItemRollerTest.gson.toJson(template)
				+ " to be in " + ItemRollerTest.gson.toJson(actual));
			...
			actual.stream()
				.allMatch(actualAttribute -> template.stream()
					.anyMatch(expectedAttribute -> ItemRollerTest
						.attributeModifierValid(expectedAttribute,
							actualAttribute))),
			"Expected everything in " + ItemRollerTest.gson.toJson(actual)
				+ " to be in " + ItemRollerTest.gson.toJson(template));
	}
