...
class TemplateTest {
    ...
    /**
     * Generate a random accessory template, then convert to and from json to make sure it can be
    ...
    void testAccessoryTemplatePersistence() {
        ...
        AccessoryTemplate parsed = gson.fromJson(gson.toJson(template), AccessoryTemplate.class);
        Assertions.assertEquals(template, parsed);
    }

    /**
     * Generate a random armor template, then convert to and from json to make sure it can be stored
    ...
    void testArmorTemplatePersistence() {
        ...
        ArmorTemplate parsed = gson.fromJson(gson.toJson(template), ArmorTemplate.class);
        Assertions.assertEquals(template, parsed);
    }

    /**
     * Generate a random component template, then convert to and from json to make sure it can be
     * stored in the database properly.
     */
    @Test
    ...
    /**
     * Generate a random weapon template, then convert to and from json to make sure it can be
     * stored in the database properly.
     */
    @Test
    void testWeaponTemplatePersistence() {
        ...
        WeaponTemplate parsed = gson.fromJson(gson.toJson(template), WeaponTemplate.class);
        Assertions.assertEquals(template, parsed);
    }
}
