...
import com.ikalagaming.rpg.item.enums.ComponentType;
...
public class ItemGenerator {
    ...
    public static Accessory getAccessory() {
        ...
        accessory.setQuality(RandomGen.selectEnumValue(Quality.class));
        accessory.setAccessoryType(RandomGen.selectEnumValue(AccessoryType.class));
        accessory.setID(
                accessory.getItemType().getPrefix()
    ...
    public static Affix getAffix() {
        ...
        affix.setAffixType(RandomGen.selectEnumValue(AffixType.class));
        ...
        affix.setQuality(RandomGen.selectEnumValue(Quality.class));
    ...
    public static Armor getArmor() {
        ...
        armor.setQuality(RandomGen.selectEnumValue(Quality.class));
        armor.setArmorType(RandomGen.selectEnumValue(ArmorType.class));
        armor.setID(
                armor.getItemType().getPrefix()
                        + armor.getArmorType().getPrefix()
                        + ItemGenerator.nextID.getAndIncrement());
    ...
    private static AttributeModifier getAttributeModifier() {
        ...
        attribute.setAttribute(RandomGen.selectEnumValue(Attribute.class));
        attribute.setType(RandomGen.selectEnumValue(ModifierType.class));
        attribute.setAmount(Math.abs(ItemGenerator.rand.nextInt(99)) + 1);
        return attribute;
    }

    /**
     * Generates a random attribute modifier template for use in generating random item templates.
     *
    ...
    private static AttributeModifierTemplate getAttributeModifierTemplate() {
        ...
        attribute.setType(RandomGen.selectEnumValue(ModifierType.class));
        attribute.setAmount(Math.abs(ItemGenerator.rand.nextInt(99)) + 1);
        attribute.setVariance(ItemGenerator.rand.nextInt(attribute.getAmount()));
        return attribute;
    }
    ...
    public static Component getComponent() {
        ...
        component.setQuality(RandomGen.selectEnumValue(Quality.class));
        component.setComponentType(RandomGen.selectEnumValue(ComponentType.class));
        component.setID(
                component.getItemType().getPrefix()
    ...
    public static Consumable getConsumable() {
        ...
        consumable.setConsumableType(RandomGen.selectEnumValue(ConsumableType.class));
        consumable.setItemLevel(Math.abs(ItemGenerator.rand.nextInt(99)) + 1);
        consumable.setQuality(RandomGen.selectEnumValue(Quality.class));
        consumable.setID(
                consumable.getItemType().getPrefix()
    ...
    private static DamageModifier getDamageModifier() {
        ...
        damage.setDamageType(RandomGen.selectEnumValue(DamageType.class));
        damage.setType(RandomGen.selectEnumValue(ModifierType.class));
        return damage;
    }

    /**
     * Generate a random damage modifier template for use in generating random item templates.
     *
    ...
    private static ItemCriteria getItemCriteria() {
        ...
        switch (ItemGenerator.rand.nextInt(3)) {
            case 0:
                ...
                accessoryTypes.add(RandomGen.selectEnumValue(AccessoryType.class));
            ...
            case 1:
                ...
                armorTypes.add(RandomGen.selectEnumValue(ArmorType.class));
            ...
            default:
                ...
                weaponTypes.add(RandomGen.selectEnumValue(WeaponType.class));
    ...
    private static ItemStats getItemStats() {
        ...
        for (int i = 0; i < maxBuffs; ++i) {
            template.getResistanceBuffs().add(ItemGenerator.getDamageModifier());
        }
        final int maxAttributes = ItemGenerator.rand.nextInt(4) + 1;
        for (int i = 0; i < maxAttributes; ++i) {
            template.getAttributeBuffs().add(ItemGenerator.getAttributeModifier());
        }
        return template;
    }
    ...
    private static ItemStatsTemplate getItemStatsTemplate() {
        ...
        final int maxDamages = ItemGenerator.rand.nextInt(4) + 1;
        for (int i = 0; i < maxDamages; ++i) {
            template.getDamageBuffs().add(ItemGenerator.getDamageModifierTemplate());
        }
        final int maxBuffs = ItemGenerator.rand.nextInt(4) + 1;
        for (int i = 0; i < maxBuffs; ++i) {
            template.getResistanceBuffs().add(ItemGenerator.getDamageModifierTemplate());
        }
        final int maxAttributes = ItemGenerator.rand.nextInt(4) + 1;
        for (int i = 0; i < maxAttributes; ++i) {
            template.getAttributeBuffs().add(ItemGenerator.getAttributeModifierTemplate());
        }
        return template;
    }
    ...
    public static Junk getJunk() {
        ...
        junk.setID(junk.getItemType().getPrefix() + ItemGenerator.nextID.getAndIncrement());
        return junk;
    }
    ...
    public static Material getMaterial() {
        ...
        material.setID(material.getItemType().getPrefix() + ItemGenerator.nextID.getAndIncrement());
        return material;
    }
    ...
    public static Quest getQuest() {
        ...
        quest.setID(quest.getItemType().getPrefix() + ItemGenerator.nextID.getAndIncrement());
        return quest;
    }
    ...
    public static Item getRandomItem() {
        switch (RandomGen.selectEnumValue(ItemType.class)) {
            case ACCESSORY:
    ...
    public static Weapon getWeapon() {
        ...
        weapon.setWeaponType(RandomGen.selectEnumValue(WeaponType.class));
        weapon.setQuality(RandomGen.selectEnumValue(Quality.class));
        weapon.setID(
                weapon.getItemType().getPrefix()
    ...
    private static void populateEquipment(Equipment equipment) {
        ...
        for (int i = 0; i < maxRequirements; ++i) {
            equipment.getAttributeRequirements().add(ItemGenerator.getAttributeModifier());
        }
        equipment.setLevelRequirement(Math.abs(ItemGenerator.rand.nextInt(99)) + 1);
    ...
    private static void populateEquipmentTemplate(EquipmentTemplate template) {
        final int maxRequirements = ItemGenerator.rand.nextInt(4) + 1;
        for (int i = 0; i < maxRequirements; ++i) {
            template.getAttributeRequirements().add(ItemGenerator.getAttributeModifierTemplate());
        }
        template.setLevelRequirement(Math.abs(ItemGenerator.rand.nextInt(99)) + 1);
