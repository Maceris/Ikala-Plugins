...
public enum ArmorType {
    ...
    /**
     * The prefix that is used in the IDs for armor of each type in the database, after the item
     * type prefix.
     *
     * @return The prefix that appears before armor of each type, after the item type prefix, in the
     *     database.
     */
