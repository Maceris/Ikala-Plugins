...
public class ItemCriteria {
    ...
    /**
     * The types of accessories that are relevant, populated only if accessory is included in the
     * list of item types.
     *
    ...
    /**
     * The types of armor that are relevant, populated only if armor is included in the list of item
     * types.
     *
    ...
    /**
     * The types of weapon that are relevant, populated only if weapon is included in the list of
     * item types.
     *
    ...
    /**
     * Construct a new item criteria to specify what item types something like components or affixes
     * can be applied to.
     */
    public ItemCriteria() {}
}
