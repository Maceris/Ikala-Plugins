...
public enum ItemType {
    /**
     * Any sort of accessory that does not provide protection in the sense that armor does, worn on
     * the body.
     */
    ...
    /**
     * The prefix that is used in the IDs for items of this type in the database.
     *
     * @return The prefix that appears before items of this type in the database.
     */
