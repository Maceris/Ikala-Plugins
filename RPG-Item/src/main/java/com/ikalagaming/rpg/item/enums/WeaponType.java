...
public enum WeaponType {
    /**
     * Items that are held in the off-hand that don't fit into the other one-handed categories, and
     * generally provide buffs like tomes or orbs.
     */
    OFF_HAND("off_hand_"),
    ...
    /**
     * Melee weapons that take two hands to hold, like great swords, great axes, mauls, or scythes.
     */
    ...
    /**
     * The prefix that is used in the IDs for weapons of each type in the database, after the item
     * type prefix.
     *
     * @return The prefix that appears before weapons of each type, after the item type prefix, in
     *     the database.
     */
