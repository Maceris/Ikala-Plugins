...
public enum AccessoryType {
    ...
    /**
     * The prefix that is used in the IDs for accessories of each type in the database, after the
     * item type prefix.
     *
     * @return The prefix that appears before accessories of each type, after the item type prefix,
     *     in the database.
     */
