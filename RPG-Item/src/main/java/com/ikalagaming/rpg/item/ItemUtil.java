...
public class ItemUtil {
    ...
    /**
     * Return the texture coordinates for icons representing slots for equipment.
     *
     * @param type The type of accessory.
     * @return The texture coordinates for that type of item.
     */
    public static ImageCoordinates getSlotTextureCoordinates(@NonNull AccessoryType type) {
        int uvUpperLeftX = 0;
        int uvUpperLeftY = 0;
        switch (type) {
            case AMULET:
     ...
     * @return The texture coordinates for that type of item.
     */
    public static ImageCoordinates getSlotTextureCoordinates(@NonNull ArmorType type) {
        int uvUpperLeftX = 0;
        int uvUpperLeftY = 0;
     ...
     * @return The texture coordinates for that type of item.
     */
    public static ImageCoordinates getSlotTextureCoordinates(@NonNull WeaponType type) {
        int uvUpperLeftX = 0;
        int uvUpperLeftY = 0;
    ...
    /**
     * Return the texture coordinates within the item sprite sheet for the given item.
     *
